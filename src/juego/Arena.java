...
public class Arena {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("Daño de la lucha 1 es " + danoLucha);
      imprimeNivelDeVida(gue1);
      imprimeNivelDeVida(mag1);

      danoLucha = Lucha (gue2, mag1, contadorGolpes);     
      System.out.println("Daño de la lucha 2 es " + danoLucha);
      imprimeNivelDeVida(gue2);
      imprimeNivelDeVida(mag1);
      ...
      System.out.println("Daño de la lucha 3 es " + danoLucha);
      ...
      System.out.println("Daño de la lucha 4 es " + danoLucha);
      imprimeNivelDeVida(gue1);
      imprimeNivelDeVida(gue2);
 
      danoLucha = Lucha ((GuerreroFuerte)gueX, mag1, contadorGolpes, 10);     
      System.out.println("Daño de la lucha 5 es " + danoLucha);
      imprimeNivelDeVida(gueX);
      imprimeNivelDeVida(mag1);
